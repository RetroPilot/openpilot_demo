...
def plannerd_thread(sm=None, pm=None):
  ...
  if sm is None:
    sm = messaging.SubMaster(['carState', 'controlsState', 'radarState', 'modelV2', 'gpsLocationExternal'],
                             poll=['radarState', 'modelV2', 'gpsLocationExternal'], ignore_avg_freq=['radarState'])
