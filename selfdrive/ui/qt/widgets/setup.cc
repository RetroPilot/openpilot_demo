...
PrimeUserWidget::PrimeUserWidget(QWidget* parent) : QWidget(parent) {
  ...
  QString url = "https://l34sn2v9eg.execute-api.us-east-1.amazonaws.com/v1/devices/" + dongleId + "/owner";
...
SetupWidget::SetupWidget(QWidget* parent) : QFrame(parent) {
  ...
  // set up API requests
  QString dongleId = QString::fromStdString(Params().get("DongleId"));
  QString url = "https://l34sn2v9eg.execute-api.us-east-1.amazonaws.com/v1.1/devices/" + dongleId + "/";
